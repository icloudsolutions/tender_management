...
# Part of Softhealer Technologies.
{
    ...
    'assets': {
        'web.assets_frontend': [
            'sh_all_in_one_tender_bundle/static/src/js/purchase_agreement_portal.js',
            'sh_all_in_one_tender_bundle/static/src/js/portal.js',
            'sh_all_in_one_tender_bundle/static/src/scss/style.scss',
            'sh_all_in_one_tender_bundle/static/src/js/country_state.js',
            'sh_all_in_one_tender_bundle/static/src/js/sh_vendor_signup.js',
